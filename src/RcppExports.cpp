...
RcppExport SEXP _KSBound_KSBound(SEXP mcmc_samplesSEXP, SEXP m_maxSEXP, SEXP spatial_neighborsSEXP, SEXP ySEXP, SEXP offsetSEXP, SEXP xSEXP, SEXP mhvar_betaSEXP, SEXP mhvar_thetaSEXP, SEXP beta_mu_priorSEXP, SEXP beta_sd_priorSEXP, SEXP sigma2_theta_a_priorSEXP, SEXP sigma2_theta_b_priorSEXP, SEXP alpha_a_priorSEXP, SEXP alpha_b_priorSEXP, SEXP beta_initSEXP, SEXP theta_initSEXP, SEXP sigma2_theta_initSEXP, SEXP g_initSEXP, SEXP v_initSEXP, SEXP alpha_initSEXP, SEXP psi_initSEXP, SEXP alpha_fixSEXP, SEXP keep_all_indSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(KSBound(mcmc_samples, m_max, spatial_neighbors, y, offset, x, mhvar_beta, mhvar_theta, beta_mu_prior, beta_sd_prior, sigma2_theta_a_prior, sigma2_theta_b_prior, alpha_a_prior, alpha_b_prior, beta_init, theta_init, sigma2_theta_init, g_init, v_init, alpha_init, psi_init, alpha_fix, keep_all_ind));
...
static const R_CallMethodDef CallEntries[] = {
    {"_KSBound_KSBound", (DL_FUNC) &_KSBound_KSBound, 23},
