...
arma::vec g_set = (g - 1);
arma::vec weights(n); weights.fill(0.00);
arma::vec v_temp(n); v_temp.fill(0.00);
double v_beta_update = 0.00;
arma::vec v(m_max); v.fill(0.00);
arma::vec psi(m_max); psi.fill(0.00);
